        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' http://localhost:3000 http://10.0.0.1:3000 ws://localhost:3000 ws://10.0.0.1:3000 https://gooseapi.ddns.net https://accounts.google.com https://*.googleusercontent.com https://*.tile.openstreetmap.org",
