/**
 * Footer Component
 * Logo, helpful links, and social icons
 */
        ...
        <div>
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              A running platform that connects athletes and coaches through structured workouts, real performance data, and seamless Garmin integration.
            </p>
            {/* Social Icons */}
